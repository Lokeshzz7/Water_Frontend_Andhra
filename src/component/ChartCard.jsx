...
const ChartCard = ({ title, chartImage, legend }) => {
  return (
    <div className="flex overflow-hidden flex-col p-5 mx-auto w-full shadow-[4px_4px_4px_rgba(0,_0,_0,_0.25),_-4px_-4px_4px_rgba(0,_0,_0,_0.25)] bg-component rounded-3xl shadow-[13px_18px_26px_rgba(0,122,255,0.46)] max-md:mt-4">
      <div className="flex gap-5 justify-between w-full font-bold">
        ...
        <div className="flex gap-0.5 self-start text-xs tracking-tight leading-loose whitespace-nowrap text-slate-400">
          ...
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/71821bcfe81efe19a3a607155b3d0dd1fa36d27714934a3c16da420337fb2500?placeholderIfAbsent=true&apiKey=5e3805d6b94248fdab855530b81db859"
            alt=""
      ...
      />
      <div className="flex overflow-hidden flex-col px-10 py-6 mx-3.5 leading-loose whitespace-nowrap shadow-[4px_4px_4px_rgba(0,_0,_0,_0.25),_-4px_-4px_4px_rgba(0,_0,_0,_0.25)] bg-component rounded-2xl max-md:px-5 max-md:mx-2.5">
