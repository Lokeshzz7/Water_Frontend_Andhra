...
const ScenarioDataCard = ({ title, value, details }) => {
    return (
        <div className="flex flex-col p-4 w-full bg-component  rounded-2xl border border-gray-100 transform transition-all duration-300 shadow-[4px_4px_4px_rgba(0,_0,_0,_0.25),_-4px_-4px_4px_rgba(0,_0,_0,_0.25)] ">
            {/* Title Section */}
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-baseline">
                    <span className="text-xl font-extrabold text-[#f19cbb] mr-2">{value}</span>
                </div>
            </div>
