...
const ScatterChart = () => {
  ...
  return <div id="main" className="w-1/2 bg-white h-[454px] rounded-lg ml-6 mt-8 mr-5 shadow-[0px_8px_26px_rgba(0,122,255,0.46),-8px_0px_26px_rgba(0,122,255,0.46)]"></div>;
};
