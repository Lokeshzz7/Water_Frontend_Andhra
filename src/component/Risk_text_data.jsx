...
const RiskAssessment = () => {
  ...
  return (
    <section className="flex flex-col items-start pt-7 pr-20 pb-36 pl-8 w-full bg-white h-full rounded-lg ml-6 mt-8 mr-4 shadow-[0px_8px_26px_rgba(0,122,255,0.46),-8px_0px_26px_rgba(0,122,255,0.46)] text-black max-md:px-5 max-md:pb-24 max-md:mt-9 max-md:max-w-full">
      <h2 className="text-6xl font-bold max-md:text-4xl text-center text-black">Risk Assessment</h2>

      <div className="mt-2 text-lg max-md:max-w-full text-black">
        ...
        {riskInfo ? (
          <>
            <div className=" pl-6">
              ...
              <p className="text-xl font-bold text-black">{riskInfo.risk}</p>
              <p className="text-3xl mt-3 font-bold text-blue-800">Cause :</p>
              <p className=" text-xl font-bold text-black">{riskInfo.cause}</p>
              <div className="mt-4">
