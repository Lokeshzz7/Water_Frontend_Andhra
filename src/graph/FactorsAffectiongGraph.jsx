...
const FactorsGraph = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const selectedYearResponse = await fetch(`${BASE_URL}/api/forecast/get-factors/${selectedDistrict}/${selectedYear}/${selectedMonth}/`);
      const selectedYearData = await selectedYearResponse.json();

      // Fetch data for 2024
      const year2024Response = await fetch(`${BASE_URL}/api/forecast/get-factors/${selectedDistrict}/2024/${selectedMonth}/`);
