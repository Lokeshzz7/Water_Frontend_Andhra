...
const FactorsGraph = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const selectedYearResponse = await fetch(`http://127.0.0.1:8000/api/forecast/get-factors/${selectedDistrict}/${selectedYear}/${selectedMonth}/`);
      const selectedYearData = await selectedYearResponse.json();

      // Fetch data for 2024
      const year2024Response = await fetch(`http://127.0.0.1:8000/api/forecast/get-factors/${selectedDistrict}/2024/${selectedMonth}/`);
      ...
      setDescription(getRiskFactorsDescription(combinedData).interpretation);
      setInsights(getRiskFactorsDescription(combinedData));
